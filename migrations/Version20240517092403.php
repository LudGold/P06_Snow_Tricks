 ...
 */
final class Version20240517092403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avatar (id INT AUTO_INCREMENT NOT NULL, avatars_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, avatar VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1677722FFA40957A (avatars_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
