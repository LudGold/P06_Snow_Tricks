 ...
 */
final class Version20240418084026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avatar DROP image_url');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avatar ADD image_url VARCHAR(255) NOT NULL');
